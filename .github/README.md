...
[`@aws-sdk/client-signer`](https://www.npmjs.com/package/@aws-sdk/client-signer/v/3.1054.0).
...
- @aws-sdk/client-signer v3.1054.0 - [https://cloud-sdk-builds.github.io/?sdk=client-signer&version=3.1054.0](https://cloud-sdk-builds.github.io/?sdk=client-signer&version=3.1054.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-signer@3.1054.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gyZLTD8hV0+zm6RdoHCsO8OJ6/VVPSs22SnR3irDQ2CELq+gDApac8oLEvuTgNGf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-signer": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-signer@3.1054.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-signer@3.1054.0/index.min.mjs": "sha384-gyZLTD8hV0+zm6RdoHCsO8OJ6/VVPSs22SnR3irDQ2CELq+gDApac8oLEvuTgNGf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-signer/blob/refs/tags/3.1054.0/LICENSE
```
