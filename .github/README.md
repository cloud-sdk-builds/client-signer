...
[`@aws-sdk/client-signer`](https://www.npmjs.com/package/@aws-sdk/client-signer/v/3.1083.0).
...
- @aws-sdk/client-signer - [https://cloud-sdk-builds.github.io/?sdk=client-signer](https://cloud-sdk-builds.github.io/?sdk=client-signer)
- @aws-sdk/client-signer v3.1083.0 - [https://cloud-sdk-builds.github.io/?sdk=client-signer&version=3.1083.0](https://cloud-sdk-builds.github.io/?sdk=client-signer&version=3.1083.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-signer@3.1083.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IHM08B4yhXnNQqQVzN/PLCkKfAs3XVUbkEpy4TFtSbbPToFjyEOqYC1/YafHEiOJ
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-signer/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-signer": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-signer@3.1083.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-signer@3.1083.0/index.min.mjs": "sha384-IHM08B4yhXnNQqQVzN/PLCkKfAs3XVUbkEpy4TFtSbbPToFjyEOqYC1/YafHEiOJ"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-signer";
...
```
https://github.com/cloud-sdk-builds/client-signer/blob/refs/tags/3.1083.0/LICENSE
```
